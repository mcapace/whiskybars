    ...
    <footer className="bg-wa-cream text-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-6">
          <div className="relative inline-block h-10 w-32 md:h-12 md:w-40">
            <Image
        ...
        {/* Social Media Icons - Centered, Circular, Orange */}
        <div className="flex justify-center gap-3 mb-6">
          <a
            href="https://www.facebook.com/WhiskyAdvocate"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full bg-wa-red flex items-center justify-center hover:opacity-80 transition-opacity"
            aria-label="Facebook"
          >
