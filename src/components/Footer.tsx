      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="border-t border-gray-800 pt-8 mb-8">
          ...
          <div className="flex flex-wrap gap-6 text-base text-gray-400">
            ...
            <a href="https://www.winespectator.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              Wine Spectator
            </a>
            <a href="https://www.marketwatchmag.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              Market Watch
            </a>
            <a href="https://www.shankennewsdaily.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              Shanken News Daily
            </a>
          </div>
        </div>
